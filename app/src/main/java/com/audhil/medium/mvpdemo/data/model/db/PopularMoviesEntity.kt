...
@Entity(
        tableName = AppDBNames.POPULAR_MOVIES_TABLE_NAME,
...
data class PopularMoviesEntity(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<PopularMoviesEntity> = object : Parcelable.Creator<PopularMoviesEntity> {
            override fun createFromParcel(source: Parcel): PopularMoviesEntity = PopularMoviesEntity(source)
            override fun newArray(size: Int): Array<PopularMoviesEntity?> = arrayOfNulls(size)
        }
    }
